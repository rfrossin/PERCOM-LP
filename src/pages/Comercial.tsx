...
export default function Home() {
  return (
    <div className="bg-[var(--color-paper)] flex flex-col items-center">
      ...
      {/* SEPARATOR MARQUEE */}
      <section className="py-8 border-b border-[var(--color-ink)] bg-[var(--color-grey-light)] overflow-hidden w-full">
        <div className="flex gap-6 whitespace-nowrap px-10 mb-4 max-w-[1024px] mx-auto w-full">
           <p className="text-[10px] font-bold tracking-[2px] uppercase text-[var(--color-grey-mid)]">Projetos Recentes</p>
        </div>
      ...
      <section className="py-24 px-10 w-full relative border-b border-[var(--color-ink)] bg-black">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <img 
            src="https://i.ibb.co/MdHD7Yh/Mudan-a-de-Layout-PERCOM-png.jpg" 
        ...
        <div className="max-w-[1024px] mx-auto relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-[56px] font-black uppercase tracking-[-2px] leading-[0.9] max-w-4xl text-[var(--color-paper)] drop-shadow-lg">
              O que você deseja do seu espaço físico para seu negócio, clientes e vendedores?
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-[var(--color-ink)] bg-[var(--color-grey-light)]">
            <div className="p-8 border-b md:border-b-0 md:border-r border-[var(--color-ink)]">
              ...
              <p className="text-[var(--color-ink)] font-medium text-sm leading-[1.6]">
                Ter um PDV operante e que agregue valor para sua empresa no menor tempo e esforço possível.
              </p>
            </div>
            ...
            <div className="p-8">
              ...
              <p className="text-[var(--color-ink)] font-medium text-sm leading-[1.6]">
                Mais rentabilidade por m² na sua loja. Sem dor de cabeça e surpresas difíceis durante o processo.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 px-10 bg-[var(--color-grey-light)] w-full border-b border-[var(--color-ink)]">
        <div className="max-w-[1024px] mx-auto">
          <SectionHeader 
            title="Desafios reais na expansão dos seus PDVs"
            subtitle="Conhecemos as dores da construção no varejo porque vivemos isso todos os dias."
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 border-t border-l border-[var(--color-ink)] bg-[var(--color-paper)]">
            {[
              ...
              { title: "Beleza x Retorno", text: "O papel aceita tudo. Nem tudo que é bonito gera retorno de conversão na operação do varejo." },
          ...
          <div className="mt-16 text-center max-w-3xl mx-auto border-t border-[var(--color-ink)] pt-8">
             <p className="text-xl font-medium text-[var(--color-ink)]">Tocar seu negócio e construir sua loja são grandes desafios simultâneos, então, <span className="font-black uppercase tracking-tight">queremos te ajudar!</span></p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-10 w-full border-b border-[var(--color-ink)]">
        <div className="max-w-[1024px] mx-auto border border-[var(--color-ink)] flex flex-col lg:flex-row">
          <div className="p-12 lg:w-1/2 border-b lg:border-b-0 lg:border-r border-[var(--color-ink)]">
            <h2 className="text-4xl md:text-[56px] font-black uppercase tracking-[-2px] leading-[0.9] mb-12">O DNA<br/>Pró-Varejo<br/><span className="text-[var(--color-grey-mid)]">da Percom</span></h2>
            <ul className="space-y-6">
              {[
                "Trabalhamos em todas etapas da sua expansão física",
                "Lidamos com todos os envolvidos no processo",
                "Expertise de Construção intensiva no Varejo",
                "Gestão de múltiplas frentes de trabalho em espaços reduzidos",
                "Disposição de HUB de parceiros especialistas em PDVs",
                "Agilidade executiva e respeito inegociável aos prazos",
                "Condutas e serviços pró-varejo (ex: plantão em inauguração)"
              ].map((item, i) => (
          ...
          <div className="lg:w-1/2 bg-[var(--color-ink)] p-8 md:p-12 text-[var(--color-paper)] flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="space-y-6 relative z-10">
               ...
               <p className="text-[16px] leading-[1.6] text-[var(--color-grey-light)] font-medium">Por isso nossa metodologia foi desenhada para a urgência e para o padrão do varejo.</p>
            </div>
      ...
      <section className="py-24 px-10 w-full relative border-y border-[var(--color-ink)]">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <img 
            src="https://i.ibb.co/zVc73X9W/In-cio-de-Projeto-PERCOM-png.jpg" 
        ...
        <div className="max-w-[1024px] mx-auto">
          ...
          <div className="text-center pt-16 border-t border-[var(--color-ink)] max-w-4xl mx-auto">
             ...
             <p className="text-sm font-medium text-[var(--color-ink)] opacity-70 max-w-2xl mx-auto leading-relaxed">
               A Percom é especializada em <strong className="font-bold">construção comercial</strong> e <strong className="font-bold">construção de lojas</strong> para o mercado varejista. Atuamos como a principal <strong className="font-bold">construtora varejo</strong> com sede na região de <strong className="font-bold">Ribeirão Preto</strong>, atendendo a todo o <strong className="font-bold">interior de São Paulo</strong> e oferecendo soluções completas de infraestrutura para franquias, shoppings e espaços corporativos.
             </p>
          </div>
        </div>
      </section>
